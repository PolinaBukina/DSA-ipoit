...
public class SourceScannerA {
    ...
    private static String readFileWithFallback(Path file) throws IOException {
        ...
        // Если все кодировки не подошли, читаем как бинарный файл и конвертируем
    ...
    private static String getRelativePath(String fullPath, String src) {
        // Используем системный разделитель файлов
        ...
        try {
            ...
            return fullPath.substring(src.length()).replace("/", File.separator).replace("\\", File.separator);
        }
    }
}